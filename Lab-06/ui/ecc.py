...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(623, 458)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(30, 220, 71, 41))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.txt_info.setGeometry(QtCore.QRect(110, 100, 341, 91))
        self.txt_info.setObjectName("txt_info")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(230, 10, 131, 51))
        font = QtGui.QFont()
        ...
        self.label_4.setGeometry(QtCore.QRect(30, 90, 81, 41))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btn_gen_keys.setGeometry(QtCore.QRect(370, 30, 101, 21))
        font = QtGui.QFont()
        ...
        self.btn_sign.setGeometry(QtCore.QRect(210, 340, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btn_verify.setGeometry(QtCore.QRect(340, 340, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.txt_sign.setGeometry(QtCore.QRect(110, 220, 341, 91))
